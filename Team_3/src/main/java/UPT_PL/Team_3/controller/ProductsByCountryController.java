...
public class ProductsByCountryController {
		...
		public ProductsByCountry updateProductsByCountry(@RequestBody ProductsByCountry productsByCountry) {

			return productsByCountryService.updateProductsByCountry(productsByCountry);

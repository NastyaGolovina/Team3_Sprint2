...
public class ProductsGridPane {
	...
	public void buildUI() {
		...
		//places each element in a specific cell in the grid , (0, 0) represent the column and row where the element should appear.
		//Label
		...
		//ensure that the TextField elements stretch horizontally to fill extra space if the window is resized.
	...
	//used to update text fields in the UI with information about a specific product.
